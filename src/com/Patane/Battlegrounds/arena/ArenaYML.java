...
public class ArenaYML {
	...
	public static Arena loadArena (String arenaName){
		...
		Arena loadedArena = new Arena(plugin, arenaName, world, region, gameSpawns, lobbySpawns, creatureSpawns, spectatorSpawns);
	...
	public static void saveRegion(String arenaName, World world, AbstractRegion selectedRegion) {
		try{
			arenasConfig.set("arenas." + arenaName + ".Poly", null);
			arenasConfig.set("arenas." + arenaName + ".Cuboid", null);
